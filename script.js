...
const getUtterancesTheme = () =>
  root.getAttribute("data-theme") === "light" ? "github-light" : "github-dark";
...
const updateViewportState = () => {
  ...
  const progress =
    docHeight > 0
      ? Math.min(100, Math.max(0, (scrolled / docHeight) * 100))
      : 0;
...
const certDetails = {
  isc2: {
    ...
    skills:
      "Cybersecurity, Information Security, Risk Management, Incident Response, Cloud Security",
    description:
      "Foundational knowledge in security principles, access controls, network security, incident response, disaster recovery, and security operations.",
  ...
  "azure-dev": {
    ...
    skills:
      "Microsoft Azure, Azure compute solutions, app services, CI/CD, security",
    description:
      "Hands-on development on Azure platforms, including building compute solutions, APIs, and secure cloud-native services.",
  ...
  comptia: {
    ...
    skills:
      "Security fundamentals, threat detection, incident response, risk management",
    description:
      "Industry-recognized certification covering network security, threat management, and identity management.",
  ...
  "google-cyber": {
    ...
    description:
      "Practical introduction to cybersecurity operations, threat detection, and risk assessment for organizational protection.",
  ...
  "azure-fund": {
    ...
    skills:
      "Azure cloud concepts, core services, pricing, security fundamentals",
    description:
      "Entry-level certification validating core Azure concepts and cloud best practices for teams adopting Microsoft cloud solutions.",
    logo: "https://upload.wikimedia.org/wikipedia/commons/4/44/Microsoft_logo.svg",
  },
  "ms-70-480": {
    ...
    description:
      "Demonstrates expertise in building responsive, standards-based web experiences using modern browser technologies.",
    logo: "https://upload.wikimedia.org/wikipedia/commons/4/44/Microsoft_logo.svg",
  },
  "ms-70-761": {
    ...
    description:
      "Covers extracting and manipulating data with Transact-SQL in SQL Server environments.",
    logo: "https://upload.wikimedia.org/wikipedia/commons/4/44/Microsoft_logo.svg",
  },
  "aws-dev": {
    ...
    skills:
      "AWS architecture, serverless development, CI/CD, security, monitoring",
    description:
      "Validates building and maintaining applications on AWS with cloud-native deployment patterns.",
  ...
  "aws-sa": {
    ...
    description:
      "Proves skill in designing secure, scalable systems on AWS that meet business requirements.",
    logo: "https://upload.wikimedia.org/wikipedia/commons/9/93/Amazon_Web_Services_Logo.svg",
  },
  "aws-cloud": {
    ...
    description:
      "Foundational AWS certification for understanding cloud fundamentals and services.",
    logo: "https://upload.wikimedia.org/wikipedia/commons/9/93/Amazon_Web_Services_Logo.svg",
  },
  sabio: {
    ...
    description:
      "Intense, hands-on program emphasizing production-quality full stack engineering on real teams.",
  ...
  cisco: {
    ...
    description:
      "Industry standard networking certification for scalable and secure enterprise network operations.",
  ...
  oracle: {
    ...
    description:
      "Validates core Java SE programming skill and fundamental object-oriented design.",
...
if (contactForm) {
  contactForm.addEventListener("submit", async (event) => {
    ...
    if (honeypot && honeypot.value) {
      if (contactStatus) {
        contactStatus.textContent =
          "Unable to send this message. Please email directly instead.";
      }
      return;
    }
    ...
    try {
      ...
      if (contactStatus) {
        contactStatus.textContent =
          "Network error while sending. Please use the direct email link.";
      }
    } finally {
      if (submitButton) {
...
// Copyright attribution for copied text
